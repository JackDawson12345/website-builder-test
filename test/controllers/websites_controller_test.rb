...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference("Website.count") do
      post websites_url, params: { website: { content: @website.content, domain_name: @website.domain_name, name: @website.name } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { content: @website.content, domain_name: @website.domain_name, name: @website.name } }
